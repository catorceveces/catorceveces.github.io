...
(Todo el código relativo a este artículo, los scripts empleados para extraer los datos, y algunas libretas provisorias de Jupyter se encuentran en [este repositorio de Github](https://github.com/catorceveces/goodreads-data-analysis))
